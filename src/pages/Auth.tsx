          ...
          >
            ...
            {mode === "login" && (
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <Button type="submit" disabled={isSubmitting}
                  className="w-full h-[52px] rounded-2xl text-sm font-semibold transition-all duration-300 outline outline-2 outline-transparent hover:outline-white/30 hover:bg-white/[0.12]"
                  style={{
            ...
            {mode === "forgot" && (
              <form onSubmit={handleForgotPassword} className="space-y-5">
                ...
                <Button type="submit" disabled={isSubmitting}
                  className="w-full h-[52px] rounded-2xl text-sm font-semibold transition-all duration-300 outline outline-2 outline-transparent hover:outline-purple-400/60"
