...
const navSections = [
  ...
  },
  {
    ...
    items: [
      { id: "social", label: "Uplyze Social Hub", icon: Globe },
...
const SUB_TAB_SLUGS: Record<string, Record<string, string>> = {
  ...
  competitors: { tracker: "tracker", benchmarks: "benchmarks", keywords: "keyword-search", gaps: "gap-analysis", content: "content-intel", swot: "swot-analysis", strategy: "ai-strategy", analysis: "site-analysis" },
};
