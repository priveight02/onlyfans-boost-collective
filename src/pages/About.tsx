    ...
    <div className="min-h-screen">
      ...
      <div className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-[#9b87f5] to-[#7E69AB]">
          ...
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-white/10 rounded-full blur-3xl transform rotate-45 transition-transform duration-1000 ease-in-out hover:rotate-90" />
          <div className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-white/10 rounded-full blur-3xl transform -rotate-12 transition-transform duration-1000 ease-in-out hover:-rotate-45" />
          <div className="absolute top-1/2 right-1/4 w-72 h-72 bg-white/10 rounded-full blur-3xl transform rotate-180 transition-transform duration-1000 ease-in-out hover:rotate-225" />
          <div className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-white/10 rounded-full blur-3xl animate-pulse" />
        </div>
