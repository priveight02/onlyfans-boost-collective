    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-primary-light/20">
      ...
      <div className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-[#9b87f5] to-[#7E69AB]">
          ...
          {/* Decorative shapes */}
          <div className="absolute top-1/3 left-1/3 w-88 h-88 bg-white/10 rounded-full blur-3xl transform rotate-90" />
          <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-white/10 rounded-full blur-3xl" />
          <div className="absolute top-1/2 left-2/3 w-80 h-80 bg-white/10 rounded-full blur-3xl transform -rotate-90" />
        </div>
