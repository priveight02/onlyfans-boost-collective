...
const FAQ = () => {
  ...
  return (
    <AnimatedBackground variant="faq">
      <PageSEO
      ...
      <div className="relative pt-32 pb-10 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-5">
            Frequently Asked <span style={{ background: "linear-gradient(90deg, hsl(262, 70%, 65%), hsl(210, 90%, 60%))", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Questions</span>
          </h1>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 rounded-xl text-lg text-white placeholder-white/30 transition-all duration-200"
              style={{
                ...
                {category.questions.map((faq, index) => (
                  ...
                  >
                    ...
                    <AccordionContent className="px-6 pb-4">
                      <div className="text-white/70 leading-relaxed text-base">{faq.answer}</div>
                    </AccordionContent>
                  </AccordionItem>
                ))}
              </Accordion>
      ...
      <section className="py-8 relative z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { icon: Clock, value: "24/7", label: "Platform Uptime", color: "hsl(262, 70%, 65%)" },
              { icon: MessageCircle, value: "<2hrs", label: "Support Response", color: "hsl(210, 90%, 60%)" },
              { icon: Shield, value: "100%", label: "GDPR Compliant", color: "hsl(155, 70%, 55%)" },
            ].map((stat) => (
              <div key={stat.label} className="p-6 rounded-xl text-center transition-all duration-300" style={{ background: "hsla(222, 30%, 12%, 0.8)", backdropFilter: "blur(16px)", border: "1px solid hsla(0, 0%, 100%, 0.08)" }}>
                <div className="w-11 h-11 rounded-xl flex items-center justify-center mx-auto mb-3" style={{ background: "hsla(0, 0%, 100%, 0.06)", border: "1px solid hsla(0, 0%, 100%, 0.1)" }}>
      ...
      <section className="pt-8 pb-20 relative overflow-hidden z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Start Growing?</h2>
          ...
          <Button
            ...
            className="text-white transition-all duration-300 px-14 py-6 text-lg font-bold rounded-xl"
            style={{ background: "linear-gradient(135deg, hsl(262, 83%, 55%), hsl(210, 90%, 50%))", boxShadow: "0 8px 24px hsla(262, 83%, 55%, 0.2)" }}
          >
            Get Started
          </Button>
        </div>
