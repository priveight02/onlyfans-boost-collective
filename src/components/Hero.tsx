          ...
          >
            ...
            <span className="relative inline-block pb-14 md:pb-20">
              ...
              <motion.span
                ...
                className="absolute -right-10 top-[55%] md:-right-16 md:top-[50%] z-20 inline-flex items-center gap-2.5 rounded-2xl px-5 py-2.5 md:px-7 md:py-3.5 text-xs md:text-base font-black whitespace-nowrap border border-white/10"
                style={{
                  background: 'linear-gradient(135deg, hsl(260,70%,65%), hsl(275,75%,60%), hsl(250,65%,68%))',
                  color: 'white',
                  boxShadow: '0 4px 20px rgba(168,120,255,0.25), 0 0 0 1px rgba(255,255,255,0.08)',
