          ...
          >
            ...
            <span className="relative inline-block pb-14 md:pb-20">
              ...
              <motion.span
                ...
                className="absolute -right-10 top-[55%] md:-right-16 md:top-[50%] z-20 inline-flex items-center gap-2.5 rounded-2xl px-5 py-2.5 md:px-7 md:py-3.5 text-xs md:text-base font-black shadow-xl whitespace-nowrap backdrop-blur-md border border-white/10"
                style={{
                  background: 'linear-gradient(135deg, hsla(260,80%,70%,0.95), hsla(280,85%,65%,0.92), hsla(250,75%,75%,0.95))',
                  color: 'white',
                  boxShadow: '0 4px 20px rgba(168,120,255,0.25), inset 0 1px 0 rgba(255,255,255,0.15)',
