          ...
          >
            ...
            <span className="relative inline-block pb-14 md:pb-20">
              ...
              <motion.span
                ...
                className="absolute -right-10 top-[55%] md:-right-16 md:top-[50%] z-20 inline-flex items-center gap-2.5 rounded-2xl px-5 py-2.5 md:px-7 md:py-3.5 text-xs md:text-base font-black shadow-xl whitespace-nowrap border border-white/10"
                style={{
                  background: 'linear-gradient(135deg, hsl(260 80% 68%), hsl(275 75% 62%), hsl(255 70% 65%))',
                  color: 'white',
                  boxShadow: '0 8px 24px hsla(265,60%,50%,0.35), inset 0 1px 0 hsla(0,0%,100%,0.2)',
