    ...
    <div className="relative flex items-center bg-gradient-to-br from-primary via-accent to-primary-accent overflow-hidden py-32">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          >
            Ready to transform your financial future? We're here to help you unlock your full potential and achieve the happy life you deserve - your success story starts with just one decision.
          </motion.p>
