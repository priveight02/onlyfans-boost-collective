...
const Services = () => {
  ...
  return (
    <section id="services" className="py-12 bg-gradient-to-br from-[hsl(210,100%,50%)] via-[hsl(200,100%,42%)] to-[hsl(195,100%,48%)] relative overflow-hidden min-h-screen flex items-center">
