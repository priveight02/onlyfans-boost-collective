    ...
    <div className="min-h-screen">
      ...
      <div className="relative py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <Link to="/join">
            <Button size="lg" className="bg-white text-gray-900 hover:bg-primary-light hover:text-primary animate-fade-in">
              Start Growing Today
            </Button>
          </Link>
        </div>
      ...
      <section className="py-24 bg-gradient-to-r from-primary to-primary-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/join">
              <Button size="lg" className="bg-white text-gray-900 hover:bg-primary-light hover:text-primary w-full sm:w-auto">
                Apply Now
              </Button>
            </Link>
            <Link to="/contact">
