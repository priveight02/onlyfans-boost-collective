...
const Services = () => {
  ...
  return (
    <section id="services" className="py-12 bg-gradient-to-b from-primary-accent/90 via-primary to-primary/95 relative overflow-hidden min-h-screen flex items-center">
