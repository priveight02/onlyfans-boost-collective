...
const PLANS = [
  ...
  },
  {
    ...
    name: "Starter",
    monthlyPrice: 9,
    credits_per_month: 325,
    features: ["325 credits/month", "CRM Access", "Basic AI tools", "1 managed account", "Community support"],
    yearlyDiscount: 0.15,
  },
  {
    id: "pro",
    name: "Pro",
    monthlyPrice: 29,
    credits_per_month: 1625,
    features: ["1,625 credits/month", "Everything in Starter", "Advanced CRM Access", "Premium AI features", "5 managed accounts", "Priority support", "On-demand top-ups"],
    highlighted: true,
    yearlyDiscount: 0.30,
  },
  {
    ...
    name: "Business",
    monthlyPrice: 79,
    credits_per_month: 6500,
    features: ["6,500 credits/month", "Everything in Pro", "Full CRM Access", "Unlimited accounts", "Dedicated support", "Team workspace", "Advanced analytics", "API access"],
    yearlyDiscount: 0.33,
  },
  {
    id: "enterprise",
