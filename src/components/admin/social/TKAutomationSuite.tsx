          ...
          <CardContent className="p-5 space-y-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              <div className="space-y-4">
                ...
                {/* Content Disclosure — same logic as Content tab */}
                <div className="space-y-2">
