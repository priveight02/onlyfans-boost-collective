                ...
                {(() => {
                  ...
                  return (
                    <button
                      ...
                      disabled={isLoading}
                      className="group/cube relative flex flex-col items-center justify-center gap-2 p-4 rounded-2xl border border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 hover:border-pink-500/40 hover:bg-pink-500/5 hover:shadow-[0_0_24px_-5px] hover:shadow-pink-500/20 disabled:opacity-50 disabled:pointer-events-none aspect-square"
                    >
                      {igConnected && <div className="absolute top-2.5 right-2.5 h-2 w-2 rounded-full bg-green-400 shadow-[0_0_6px] shadow-green-400/60" />}
                      <div className="relative">
                ...
                {[
                  ...
                  return (
                    <div key={p.id} className="group/wrap relative">
                      ...
                      >
                        {p.connected && <div className="absolute top-2.5 right-2.5 h-2 w-2 rounded-full bg-green-400 shadow-[0_0_6px] shadow-green-400/60" />}
                        <div className="relative">
                        ...
                        <span className="text-[11px] font-semibold text-muted-foreground group-hover/cube:text-foreground transition-colors leading-tight text-center">{p.label}</span>
                      </button>
