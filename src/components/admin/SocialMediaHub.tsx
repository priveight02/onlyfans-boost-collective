          ...
          <Tabs defaultValue="session" className="space-y-4">
            ...
            <TabsContent value="one-click" className="space-y-5">
              ...
              <div className="grid grid-cols-5 gap-3">
                ...
                {(() => {
                  ...
                  return (
                    <button
                      ...
                      disabled={isLoading}
                      className="group/cube relative flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 hover:border-pink-500/40 hover:bg-pink-500/5 hover:shadow-[0_0_24px_-4px] hover:shadow-pink-500/25 disabled:opacity-50 disabled:pointer-events-none"
                    >
                      {igConnected && <div className="absolute top-2.5 right-2.5 h-2 w-2 rounded-full bg-green-400 shadow-[0_0_8px] shadow-green-400/60" />}
                      <div className="relative">
                        {isLoading ? <Loader2 className="h-10 w-10 text-pink-400 animate-spin" /> : <Instagram className="h-10 w-10 text-pink-400 transition-all duration-300 group-hover/cube:text-pink-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(236,72,153,0.5)]" />}
                      </div>
                      <div className="flex flex-col items-center gap-0.5">
                        <span className="text-xs font-semibold text-foreground">Instagram</span>
                        <span className="text-[9px] text-muted-foreground text-center leading-tight">Posts, stories & reels</span>
                      </div>
                    </button>
                  );
                })()}
                ...
                {[
                  { id: "facebook", name: "Facebook", desc: "Pages & groups", icon: Globe, hoverBorder: "hover:border-blue-500/40", hoverBg: "hover:bg-blue-500/5", hoverShadow: "hover:shadow-blue-500/25", iconColor: "text-blue-500", hoverIcon: "group-hover/cube:text-blue-400 group-hover/cube:drop-shadow-[0_0_12px_rgba(59,130,246,0.5)]", connected: facebookConnected, action: automatedFacebookConnect, expandFields: [{ val: fbAppId, set: setFbAppId, placeholder: "App ID", type: "text" }] },
                  { id: "tiktok", name: "TikTok", desc: "Videos & analytics", icon: Music2, hoverBorder: "hover:border-cyan-400/40", hoverBg: "hover:bg-cyan-400/5", hoverShadow: "hover:shadow-cyan-400/25", iconColor: "text-cyan-400", hoverIcon: "group-hover/cube:text-cyan-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(34,211,238,0.5)]", connected: ttConnected, action: automatedTikTokConnect, expandFields: [{ val: ttClientKey, set: setTtClientKey, placeholder: "Client Key", type: "text" }, { val: ttClientSecret, set: setTtClientSecret, placeholder: "Secret", type: "password" }] },
                  { id: "twitter", name: "X", desc: "Tweets & engagement", icon: Twitter, hoverBorder: "hover:border-sky-400/40", hoverBg: "hover:bg-sky-400/5", hoverShadow: "hover:shadow-sky-400/25", iconColor: "text-sky-400", hoverIcon: "group-hover/cube:text-sky-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(56,189,248,0.5)]", connected: xConnected, action: automatedTwitterConnect, expandFields: [{ val: xClientId, set: setXClientId, placeholder: "Client ID", type: "text" }, { val: xClientSecret, set: setXClientSecret, placeholder: "Secret", type: "password" }] },
                  { id: "reddit", name: "Reddit", desc: "Subreddits & posts", icon: Globe, hoverBorder: "hover:border-orange-400/40", hoverBg: "hover:bg-orange-400/5", hoverShadow: "hover:shadow-orange-400/25", iconColor: "text-orange-400", hoverIcon: "group-hover/cube:text-orange-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(251,146,60,0.5)]", connected: redditConnected, action: automatedRedditConnect, expandFields: [{ val: redditClientId, set: setRedditClientId, placeholder: "App ID", type: "text" }, { val: redditClientSecret, set: setRedditClientSecret, placeholder: "Secret", type: "password" }] },
                  { id: "telegram", name: "Telegram", desc: "Bot messaging", icon: Phone, hoverBorder: "hover:border-blue-400/40", hoverBg: "hover:bg-blue-400/5", hoverShadow: "hover:shadow-blue-400/25", iconColor: "text-blue-400", hoverIcon: "group-hover/cube:text-blue-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(96,165,250,0.5)]", connected: telegramConnected, action: automatedTelegramConnect, expandFields: [{ val: telegramBotToken, set: setTelegramBotToken, placeholder: "Bot Token", type: "password" }] },
                  { id: "threads", name: "Threads", desc: "Text posts & replies", icon: MessageCircle, hoverBorder: "hover:border-purple-400/40", hoverBg: "hover:bg-purple-400/5", hoverShadow: "hover:shadow-purple-400/25", iconColor: "text-purple-400", hoverIcon: "group-hover/cube:text-purple-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(192,132,252,0.5)]", connected: threadsConnected, action: automatedThreadsConnect, expandFields: [{ val: threadsAppId, set: setThreadsAppId, placeholder: "App ID", type: "text" }, { val: threadsAppSecret, set: setThreadsAppSecret, placeholder: "Secret", type: "password" }] },
                  { id: "whatsapp", name: "WhatsApp", desc: "Business messaging", icon: Phone, hoverBorder: "hover:border-green-400/40", hoverBg: "hover:bg-green-400/5", hoverShadow: "hover:shadow-green-400/25", iconColor: "text-green-400", hoverIcon: "group-hover/cube:text-green-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(74,222,128,0.5)]", connected: whatsappConnected, action: automatedWhatsAppConnect, expandFields: [{ val: waPhoneNumberId, set: setWaPhoneNumberId, placeholder: "Phone ID", type: "text" }, { val: waAccessToken, set: setWaAccessToken, placeholder: "Token", type: "password" }] },
                  { id: "snapchat", name: "Snap", desc: "Ads & marketing", icon: Camera, hoverBorder: "hover:border-yellow-400/40", hoverBg: "hover:bg-yellow-400/5", hoverShadow: "hover:shadow-yellow-400/25", iconColor: "text-yellow-400", hoverIcon: "group-hover/cube:text-yellow-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(250,204,21,0.5)]", connected: snapchatConnected, action: automatedSnapchatConnect, expandFields: [{ val: snapClientId, set: setSnapClientId, placeholder: "Client ID", type: "text" }, { val: snapClientSecret, set: setSnapClientSecret, placeholder: "Secret", type: "password" }] },
                  { id: "youtube", name: "YouTube", desc: "Channel & uploads", icon: Play, hoverBorder: "hover:border-red-400/40", hoverBg: "hover:bg-red-400/5", hoverShadow: "hover:shadow-red-400/25", iconColor: "text-red-400", hoverIcon: "group-hover/cube:text-red-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(248,113,113,0.5)]", connected: youtubeConnected, action: automatedYouTubeConnect, expandFields: [{ val: ytClientId, set: setYtClientId, placeholder: "Client ID", type: "text" }, { val: ytClientSecret, set: setYtClientSecret, placeholder: "Secret", type: "password" }] },
                  { id: "pinterest", name: "Pinterest", desc: "Pins & boards", icon: Target, hoverBorder: "hover:border-rose-400/40", hoverBg: "hover:bg-rose-400/5", hoverShadow: "hover:shadow-rose-400/25", iconColor: "text-rose-400", hoverIcon: "group-hover/cube:text-rose-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(251,113,133,0.5)]", connected: pinterestConnected, action: automatedPinterestConnect, expandFields: [{ val: pinAppId, set: setPinAppId, placeholder: "App ID", type: "text" }, { val: pinAppSecret, set: setPinAppSecret, placeholder: "Secret", type: "password" }] },
                  { id: "discord", name: "Discord", desc: "Server bot access", icon: Gamepad2, hoverBorder: "hover:border-indigo-400/40", hoverBg: "hover:bg-indigo-400/5", hoverShadow: "hover:shadow-indigo-400/25", iconColor: "text-indigo-400", hoverIcon: "group-hover/cube:text-indigo-300 group-hover/cube:drop-shadow-[0_0_12px_rgba(129,140,248,0.5)]", connected: discordConnected, action: automatedDiscordConnect, expandFields: [{ val: discordBotToken, set: setDiscordBotToken, placeholder: "Bot Token", type: "password" }] },
                  { id: "signal", name: "Signal", desc: "Private messaging", icon: Shield, hoverBorder: "hover:border-sky-300/40", hoverBg: "hover:bg-sky-300/5", hoverShadow: "hover:shadow-sky-300/25", iconColor: "text-sky-300", hoverIcon: "group-hover/cube:text-sky-200 group-hover/cube:drop-shadow-[0_0_12px_rgba(125,211,252,0.5)]", connected: signalConnected, action: automatedSignalConnect, expandFields: [{ val: signalApiUrl, set: setSignalApiUrl, placeholder: "API URL", type: "text" }, { val: signalPhoneNumber, set: setSignalPhoneNumber, placeholder: "Phone", type: "text" }] },
                ].map(p => {
                  ...
                  return (
                    <div key={p.id} className="group/wrap relative">
                      <button
                        ...
                        disabled={isLoading}
                        className={`group/cube relative flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 ${p.hoverBorder} ${p.hoverBg} hover:shadow-[0_0_24px_-4px] ${p.hoverShadow} disabled:opacity-50 disabled:pointer-events-none w-full`}
                      >
                        {p.connected && <div className="absolute top-2.5 right-2.5 h-2 w-2 rounded-full bg-green-400 shadow-[0_0_8px] shadow-green-400/60" />}
                        <div className="relative">
                          {isLoading ? <Loader2 className={`h-10 w-10 ${p.iconColor} animate-spin`} /> : <p.icon className={`h-10 w-10 ${p.iconColor} transition-all duration-300 ${p.hoverIcon}`} />}
                        </div>
                        <div className="flex flex-col items-center gap-0.5">
                          <span className="text-xs font-semibold text-foreground truncate max-w-full">{p.name}</span>
                          <span className="text-[9px] text-muted-foreground text-center leading-tight">{p.desc}</span>
                        </div>
                      </button>
