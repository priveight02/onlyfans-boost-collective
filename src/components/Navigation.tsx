...
const Navigation = () => {
  ...
  return (
    <div className={`w-full fixed top-0 ${isPlatform ? 'flex justify-start pt-1.5 px-2 pointer-events-none' : 'flex justify-center pt-4 px-4'}`} style={isPlatform ? { left: '360px', width: 'auto', right: 'auto', zIndex: 40 } : { zIndex: 50 }}>
      <nav
